...
// .fixbug.ResultCode result = 1;
inline bool GetFriendListsRequest::_internal_has_result() const {
  return this != internal_default_instance() && result_ != nullptr;
}
inline bool GetFriendListsRequest::has_result() const {
  return _internal_has_result();
}
inline void GetFriendListsRequest::clear_result() {
  if (GetArenaNoVirtual() == nullptr && result_ != nullptr) {
    delete result_;
  }
  result_ = nullptr;
}
inline const ::fixbug::ResultCode& GetFriendListsRequest::_internal_result() const {
  const ::fixbug::ResultCode* p = result_;
  return p != nullptr ? *p : *reinterpret_cast<const ::fixbug::ResultCode*>(
      &::fixbug::_ResultCode_default_instance_);
}
inline const ::fixbug::ResultCode& GetFriendListsRequest::result() const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListsRequest.result)
  return _internal_result();
}
inline ::fixbug::ResultCode* GetFriendListsRequest::release_result() {
  // @@protoc_insertion_point(field_release:fixbug.GetFriendListsRequest.result)
  
  ::fixbug::ResultCode* temp = result_;
  result_ = nullptr;
  return temp;
}
inline ::fixbug::ResultCode* GetFriendListsRequest::_internal_mutable_result() {
...
inline ::fixbug::ResultCode* GetFriendListsRequest::mutable_result() {
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriendListsRequest.result)
  return _internal_mutable_result();
}
inline void GetFriendListsRequest::set_allocated_result(::fixbug::ResultCode* result) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete result_;
  }
  ...
  result_ = result;
  // @@protoc_insertion_point(field_set_allocated:fixbug.GetFriendListsRequest.result)
}
