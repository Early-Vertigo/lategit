...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_GetFriendListsRequest_test_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_GetFriendListsRequest_test_2eproto}, {
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_test_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendListsRequest, result_),
  ~0u,  // no _has_bits_
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_test_2eproto = {
  &descriptor_table_test_2eproto_initialized, descriptor_table_protodef_test_2eproto, "test.proto", 690,
...
void GetFriendListsRequest::InitAsDefaultInstance() {
  ::fixbug::_GetFriendListsRequest_default_instance_._instance.get_mutable()->result_ = const_cast< ::fixbug::ResultCode*>(
      ::fixbug::ResultCode::internal_default_instance());
}
class GetFriendListsRequest::_Internal {
 public:
  static const ::fixbug::ResultCode& result(const GetFriendListsRequest* msg);
};

const ::fixbug::ResultCode&
GetFriendListsRequest::_Internal::result(const GetFriendListsRequest* msg) {
  return *msg->result_;
}
